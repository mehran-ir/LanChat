...
# پالت رنگی دکمه‌ها — دقیقاً همان سه رنگ درخواستی کاربر (از تصویر مرجع):
# آبی برای عملیات عادی، بنفش برای لغو/حذف، سبز فقط برای دکمه ارسال.
BUTTON_PALETTE = {
    "primary": "#0067EC",    # آبی — عملیات عادی
    "secondary": "#B73EF8",  # بنفش — لغو / حذف
    "success": "#00B751",    # سبز — فقط دکمه(های) ارسال
}
